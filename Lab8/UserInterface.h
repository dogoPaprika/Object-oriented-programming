...
private:
	...
	void addMovieUserInterface(char parameters[][300]);

	//calls the controller function of deleting an existing movie
	void deleteMovieUserInterface(char parameters[][300]);

	//calls the update function from controller
	void updateMovieUserInterface(char parameters[][300]);


	void listWatchList();

	void saveMovieUserInterface(string movieTitle);
