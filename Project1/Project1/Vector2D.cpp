...
{
	numberOfInstances++;
	std::cout << "Constructor (" << this->xCoordinate << "," << this->yCoordinate << ") " << numberOfInstances << std::endl;
}
...
Vector2D::Vector2D(const Vector2D& v)
{
	...
	std::cout << "Copy Constructor (" << this->xCoordinate << "," << this->yCoordinate << ") " << numberOfInstances << std::endl;
}

Vector2D::~Vector2D()
{
	std::cout << "Destructor (" << this->xCoordinate << "," << this->yCoordinate << ") " << std::endl;
...
std::string Vector2D::toString()
{
	...
	txt << "X and Y coordinates: (" << this->xCoordinate << "," << this->yCoordinate << "-" << numberOfInstances << ")" << std::endl;
	return txt.str();
}
...
Vector2D& Vector2D::operator=(const Vector2D& v)
{
	this->xCoordinate = v.xCoordinate;
	this->yCoordinate = v.yCoordinate;
	std::cout << "Assignment operator (" << this->xCoordinate << "," << this->yCoordinate << ") " << numberOfInstances << std::endl;
	return *this;
}
